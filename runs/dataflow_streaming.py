...
from experiments.wordcount import WindowWordCountGoogleDataFlow, WindowWordCountFlinkDataFlow
...
benchmarks = [
    ...
    Benchmark(
        id = "WindowWordCountGoogleDataFlow",
        systems = [flink],
        experiment = WindowWordCountGoogleDataFlow(),
        times = 3
    ),

    Benchmark(
        id = "WindowWordCountFlinkDataFlow",
        systems = [flink],
        experiment = WindowWordCountFlinkDataFlow(),
        times = 3
    ),
